...
Then (L \ T) "union" (R "snitt" T) is a minimum vertex cover. Thus, the Hopcroft-Karp algorithm for finding maximum matchings in bipartite graphs may also be used to solve the vertex cover problem efficiently in these graphs.
*/
}
