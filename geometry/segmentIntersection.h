...
int segmentIntersection(const P& s1, const P& e1,
	...
	T a = v1.cross(v2), a1 = v1.cross(d), a2 = v2.cross(d);
	if (a == 0) { //if parallell
		T b1=s1.dot(v1), c1=e1.dot(v1), b2=s2.dot(v1),c2=e2.dot(v1);
		if (a1!=0 || a2!=0 || max(b1,min(b2,c2))>min(c1,max(b2,c2)))
			return 0;
